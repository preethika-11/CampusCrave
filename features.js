                ...
                <main class="grid grid-3">
                    ...
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-envelope"></i> <p>admission@mit.co.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Kundrathur, Chennai-600092</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: www.mit.in</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
                ...
                <main class="grid grid-3">
                    ...
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-envelope"></i> <p>admission@mit.co.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Kundrathur, Chennai-600092</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: www.mil.ac.in</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
